...
public class EnemyTest {
    ...
    void testShoot(){
        ...
        Enemy e  = new Enemy( Commons.WORLD_X_START , Commons.WORLD_Y_START, bm, TypeOfEnemy.BASE);
    ...
    void testMove(){
         ...
         */
        int dx1 = 10;
        Enemy e1  = new Enemy( Commons.WORLD_X_START-100, Commons.WORLD_Y_START, bm, TypeOfEnemy.BASE);
         ...
         */
        int dx2 = 10;
        Enemy e2  = new Enemy( Commons.WORLD_X_END, Commons.WORLD_Y_START, bm, TypeOfEnemy.BASE);
